...
/**
 * Solana Transaction item in response
 */
export const SolanaTransactionSchema = z.object({
    transactionHash: z.string().describe("Transaction signature"),
    blockHeight: z.number().describe("Block height (slot)"),
...
export const ListTransactionsOutputSchema = z.object({
    items: z.array(SolanaTransactionSchema).describe("List of transactions"),
